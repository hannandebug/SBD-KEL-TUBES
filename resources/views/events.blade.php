                    ...
                    <div style="padding: 20px; display: flex; flex-direction: column;">
                        ...
                        <div style="display: flex; gap: 10px; margin-top: auto;">
                            ...
                            @if(Auth::check())
                                ...
                                @else
                                    <form method="POST" action="{{ route('event.rsvp', $event->id_event) }}" style="flex: 1;">
                                        @csrf
                                        <button type="submit" style="width: 100%; padding: 8px 12px; background: #27ae60; color: white; border: none; border-radius: 4px; font-size: 13px; font-weight: 600; cursor: pointer;">RSVP</button>
                                    </form>
                                @endif
                            @else
                                <button onclick="openLoginModal()" style="flex: 1; padding: 8px 12px; background: #27ae60; color: white; border: none; border-radius: 4px; font-size: 13px; font-weight: 600; cursor: pointer;">RSVP</button>
                            @endif
                        </div>
                    </div>
                </div>
